    ...
    <div className="wd-people-details position-fixed top-0 end-0 bottom-0 bg-white p-4 shadow w-25">
      ...
      <b>Roles:</b> 
        <span className="wd-roles">
          {!editing && (
            <span className="w-50 wd-edit-role" onClick={() => setEditing(true)} > {user.role} </span>
          )}
          {editing && (
      ...
      <b>Email:</b> {!editing && (<span className="wd-total-activity" onClick={()=>{setEditing(true)}}>{user.email}</span> )} 
      {user && editing && (
