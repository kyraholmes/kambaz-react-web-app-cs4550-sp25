    ...
    <tbody>
     <tr>
      ...
      <tr>
        ...
        <td className="wd-login-id">001245561S</td>
        <td className="wd-section">S101</td>
        <td className="wd-role">TA</td>
        <td className="wd-last-activity">2025-02-01</td>
        <td className="wd-total-activity">11:15:31</td>
      </tr>
      <tr>
        <td className="wd-full-name text-nowrap">
            <FaUserCircle className="me-2 fs-1 text-secondary" />
        ...
        <td className="wd-login-id">001235671S</td>
        <td className="wd-section">S101</td>
        <td className="wd-role">STUDENT</td>
        <td className="wd-last-activity">2025-01-26</td>
        <td className="wd-total-activity">01:36:36</td>
      </tr>
      <tr>
        <td className="wd-full-name text-nowrap">
            <FaUserCircle className="me-2 fs-1 text-secondary" />
        ...
        <td className="wd-total-activity">04:01:58</td>
      </tr>
    </tbody>
   </Table>
  </div> 
